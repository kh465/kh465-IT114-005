...
public class ClientUI extends JFrame implements IConnectionEvents, IMessageEvents, IRoomEvents, ICardControls {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> new ClientUI("kh465-Client"));
    }
    ...
    @Override //kh465 11/26/24 - i don't think this is ever used, i was simply trying things when DMs weren't working
    public void onDMReceive(long clientId, long recipientClientId, String message)
    {
        if (currentCard.ordinal() >= CardView.CHAT.ordinal())
        {
            String clientName = Client.INSTANCE.getClientNameFromId(clientId);
